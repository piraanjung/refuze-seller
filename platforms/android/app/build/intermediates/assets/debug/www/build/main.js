...
var map = {
	...
	"../pages/find-buyers/find-buyers.module": [
		348,
		17
	],
	"../pages/find-items/find-items.module": [
		349,
		3
	],
	"../pages/find-seller/find-seller.module": [
		350,
		6
	],
	"../pages/main-menu-purchase-items/main-menu-purchase-items.module": [
		351,
		14
	],
	"../pages/profile-seller/profile-seller.module": [
		352,
		16
	],
	...
	"../pages/purchase-items-modal/purchase-items-modal.module": [
		354,
		15
	],
	"../pages/purchase-items/purchase-items.module": [
		355,
		4
	]
};
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["h" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_5__app_component__["a" /* MyApp */], {}, {
                    links: [
                        ...
                        { loadChildren: '../pages/find-buyers/find-buyers.module#FindBuyersPageModule', name: 'FindBuyersPage', segment: 'find-buyers', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/find-items/find-items.module#FindItemsPageModule', name: 'find-items', segment: 'find-items', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/find-seller/find-seller.module#FindSellerPageModule', name: 'find-seller', segment: 'find-seller', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/main-menu-purchase-items/main-menu-purchase-items.module#MainMenuPurchaseItemsPageModule', name: 'main-menu-purchase-items', segment: 'main-menu-purchase-items', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/profile-seller/profile-seller.module#ProfileSellerPageModule', name: 'ProfileSellerPage', segment: 'profile-seller', priority: 'low', defaultHistory: [] },
                        ...
                        { loadChildren: '../pages/purchase-items-modal/purchase-items-modal.module#PurchaseItemsModalPageModule', name: 'purchase-items-modal', segment: 'purchase-items-modal', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/purchase-items/purchase-items.module#PurchaseItemsPageModule', name: 'purchase-items', segment: 'purchase-items', priority: 'low', defaultHistory: [] }
                    ]
                })
            ],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__ = __webpack_require__(190);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_observable_timer__ = __webpack_require__(270);
...
var MyApp = (function () {
    function MyApp(platform, statusBar, splashScreen) {
        ...
        platform.ready().then(function () {
            ...
            splashScreen.hide();
            Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_observable_timer__["timer"])(7000).subscribe(function () { return _this.showSplash = false; });
        });
    }
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/piraan/Desktop/refuze-app/refuze-app/src/app/app.html"*/'<!-- <div *ngIf="showSplash" class="splash">\n    <div class="spinner">sss</div>\n  </div>\n  \n<ion-nav [root]="rootPage"></ion-nav> -->\n<div id="splash-screen-layout-2">\n        <ion-row id="splash-background-image">\n                <img class="splash-screen" [src]="data.backgroundImage" />\n                <div class="logo-title item-fade-in">\n                  <img class="logo" [src]="data.logo" />\n                  <h2>{{data.title}}</h2>\n                </div>\n              </ion-row>\n</div>\n\n<ion-nav [root]="rootPage"  *ngIf="!showSplash"></ion-nav>'/*ion-inline-end:"/Users/piraan/Desktop/refuze-app/refuze-app/src/app/app.html"*/
        }),
